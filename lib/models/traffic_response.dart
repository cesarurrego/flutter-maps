...
//
//     final TrafficRespnse = TrafficRespnseFromJson(jsonString);

import 'dart:convert';

TrafficRespnse trafficRespnseFromJson(String str) => TrafficRespnse.fromJson(json.decode(str));

String trafficRespnseToJson(TrafficRespnse data) => json.encode(data.toJson());

class TrafficRespnse {
    TrafficRespnse({
        this.routes,
        this.waypoints,
        this.code,
    ...
    factory TrafficRespnse.fromJson(Map<String, dynamic> json) => TrafficRespnse(
